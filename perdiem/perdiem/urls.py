...
urlpatterns = [
    ...
    url(r'^terms of use/?$', TemplateView.as_view(template_name='extra/terms.html'), name='terms'),
    url(r'^trust & safety/?$', TemplateView.as_view(template_name='extra/trust.html'), name='trust'),
